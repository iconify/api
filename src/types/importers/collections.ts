 ...
 */
export type CreateIconSetImporterResult = BaseIconSetImporter &
	BaseDownloader<IconSetImportedData>;
export type CreateIconSetImporter = (
	prefix: string
) => MaybeAsync<CreateIconSetImporterResult>;
...
export interface BaseCollectionsImporter extends BaseMainImporter {
	...
	_loadCollectionsListFromDirectory?: (
		path: string
